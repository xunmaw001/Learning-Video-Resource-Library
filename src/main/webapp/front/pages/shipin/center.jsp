					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shipinUuidNumber" id="shipinUuidNumber" lay-verify="required" placeholder="视频编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shipinName" id="shipinName" lay-verify="required" placeholder="视频名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shipinVideo" id="shipinVideo" lay-verify="required" placeholder="视频" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shipinClicknum" id="shipinClicknum"  lay-verify="required|integer"   placeholder="热度" autocomplete="off" class="layui-input">
							</div>
						</div>
