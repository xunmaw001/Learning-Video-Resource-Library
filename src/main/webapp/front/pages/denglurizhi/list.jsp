            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">登录日志展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">登录详情</label>
                          <div class="layui-input-inline">
                              <input type="text" name="denglurizhiName" id="denglurizhiName" placeholder="登录详情" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#denglurizhiName').val() != null && jquery('#denglurizhiName').val() != "" && jquery('#denglurizhiName').val() != "null" ) {
                param['denglurizhiName'] = jquery('#denglurizhiName').val();
            }
                

            // 获取列表数据
            http.request('denglurizhi/list', 'get', param, function(res) {
