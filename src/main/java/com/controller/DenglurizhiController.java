    ...
    */
    ...
    public R save(@RequestBody DenglurizhiEntity denglurizhi, HttpServletRequest request){
        ...
        Wrapper<DenglurizhiEntity> queryWrapper = new EntityWrapper<DenglurizhiEntity>()
            .eq("denglurizhi_name", denglurizhi.getDenglurizhiName())
            ;
...
//                            denglurizhiEntity.setDenglurizhiName(data.get(0));                    //登录详情 要改的
...
//                            denglurizhiEntity.setCreateTime(date);//时间
    ...
    */
    @RequestMapping("/add")
    public R add(@RequestBody DenglurizhiEntity denglurizhi, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,denglurizhi:{}",this.getClass().getName(),denglurizhi.toString());
        Wrapper<DenglurizhiEntity> queryWrapper = new EntityWrapper<DenglurizhiEntity>()
            .eq("denglurizhi_name", denglurizhi.getDenglurizhiName())
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
